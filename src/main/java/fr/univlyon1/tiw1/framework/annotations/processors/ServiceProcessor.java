...
@SupportedAnnotationTypes("fr.univlyon1.tiw1.framework.annotations.Service")
public class ServiceProcessor extends CustomProcessor {
        ...
        for (TypeElement annotation : annotations) {
            ...
            for (Element element : roundEnv.getElementsAnnotatedWith(annotation)) {
                ...
                TypeSpec subComponent = TypeSpec
                        .classBuilder(ClassName.bestGuess(element.toString() + "_Service"))
                        .superclass(element.asType())
                        .addModifiers(Modifier.PUBLIC)
                        .addAnnotation(AnnotationSpec.builder(Component.class).addMember("type", "$T.$L", COMPONENT_TYPE.class, COMPONENT_TYPE.SERVICE.name()).build())
                        .build();
