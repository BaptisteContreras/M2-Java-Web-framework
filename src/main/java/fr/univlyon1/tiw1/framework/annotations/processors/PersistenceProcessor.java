...
@SupportedAnnotationTypes("fr.univlyon1.tiw1.framework.annotations.Persistence")
public class PersistenceProcessor extends CustomProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        for (TypeElement annotation : annotations) {
            ...
            for (Element element : roundEnv.getElementsAnnotatedWith(annotation)) {
                logger.info("Persistence annoté : " + element.toString());
                ...
                TypeSpec subComponent = TypeSpec
                        ...
                        .addAnnotation(AnnotationSpec.builder(Component.class).addMember("type", "$T.$L", COMPONENT_TYPE.class, COMPONENT_TYPE.PERSISTENCE.name()).build())
                        .build();
